...
var info = require('../../../../env/local.js'); // If this doesn't work it's Chris' fault.
...
var mailTo = 'A Client <client@website.com>'; // Follow the syntax exactly. Note below.
...
var transporter = nodemailer.createTransport(info.mailer.url);
